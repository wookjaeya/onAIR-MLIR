...
**다음 작업(확정)**: **E36b — ResNet·DeepAE의 AArch64 확장** — 모델당 한 번의 `iree-compile`로 AArch64 vmfb·계약·헤더를
...
- *"단계 1~5를 완료했다"* → **v0.39에서 단계 2는 닫혔다**(E36, `stage_2_complete: true`). E34는 여전히 §10 단계 4의 AArch64 cFS 절차 미실행이므로 **"단계 1·2·3·5 완료, 단계 4는 잔여 셀 있음"**이 정확하다
