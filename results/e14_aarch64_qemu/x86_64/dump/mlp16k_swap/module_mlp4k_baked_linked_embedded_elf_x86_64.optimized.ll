...
@0 = internal constant [19 x i8] c"mlp4k_baked_linked\00", align 1
...
@iree_hal_executable_library_query_v0_funcs = internal constant [2 x ptr] [ptr @infer_dispatch_0_matmul_1x4096x9_f32, ptr @infer_dispatch_1_matmul_1x2x4096_f32]
...
@1 = internal constant [37 x i8] c"infer_dispatch_0_matmul_1x4096x9_f32\00", align 1
@2 = internal constant [37 x i8] c"infer_dispatch_1_matmul_1x2x4096_f32\00", align 1
@iree_hal_executable_library_query_v0_names = internal constant [2 x ptr] [ptr @1, ptr @2]
@3 = internal constant [89 x i8] c"results/e14_aarch64_qemu/x86_64/dump/mlp16k_swap/configured_module_infer_dispatch_0.mlir\00", align 1
@4 = internal constant [89 x i8] c"results/e14_aarch64_qemu/x86_64/dump/mlp16k_swap/configured_module_infer_dispatch_1.mlir\00", align 1
@iree_hal_executable_library_query_v0_source_locations = internal constant [2 x %iree_hal_executable_source_location_v0_t] [%iree_hal_executable_source_location_v0_t { i32 3, i32 88, ptr @3 }, %iree_hal_executable_source_location_v0_t { i32 3, i32 88, ptr @4 }]
@iree_hal_executable_library_query_v0_infer_dispatch_0_matmul_1x4096x9_f32_stage_names = internal constant [0 x ptr] zeroinitializer
@iree_hal_executable_library_query_v0_infer_dispatch_0_matmul_1x4096x9_f32_stage_source_locations = internal constant [0 x %iree_hal_executable_source_location_v0_t] zeroinitializer
@iree_hal_executable_library_query_v0_infer_dispatch_1_matmul_1x2x4096_f32_stage_names = internal constant [0 x ptr] zeroinitializer
@iree_hal_executable_library_query_v0_infer_dispatch_1_matmul_1x2x4096_f32_stage_source_locations = internal constant [0 x %iree_hal_executable_source_location_v0_t] zeroinitializer
...
define internal noundef i32 @infer_dispatch_0_matmul_1x4096x9_f32(ptr noalias nonnull readnone align 16 captures(none) %0, ptr noalias noundef nonnull readonly align 16 captures(none) %1, ptr noalias noundef nonnull readonly align 16 captures(none) %2) #0 !dbg !11 {
  %.elt19 = getelementptr inbounds nuw i8, ptr %1, i64 32, !dbg !87
  %.unpack20 = load ptr, ptr %.elt19, align 16, !dbg !87
  %4 = load ptr, ptr %.unpack20, align 8, !dbg !87
  ...
  %7 = getelementptr i8, ptr %.unpack20, i64 16, !dbg !89
...
20:                                               ; preds = %3, %20
  ...
  %22 = phi i64 [ 0, %3 ], [ 32, %20 ]
  %23 = or disjoint i64 %22, %11, !dbg !90
  %24 = getelementptr [4 x i8], ptr %6, i64 %23, !dbg !90
  %25 = load <32 x float>, ptr %24, align 64, !dbg !90
  %26 = getelementptr i8, ptr %24, i64 16384, !dbg !90
  %27 = load <32 x float>, ptr %26, align 64, !dbg !90
  %28 = getelementptr i8, ptr %24, i64 32768, !dbg !90
  %29 = load <32 x float>, ptr %28, align 64, !dbg !90
  %30 = getelementptr i8, ptr %24, i64 49152, !dbg !90
  %31 = load <32 x float>, ptr %30, align 64, !dbg !90
  %32 = getelementptr i8, ptr %24, i64 65536, !dbg !90
  %33 = load <32 x float>, ptr %32, align 64, !dbg !90
  %34 = getelementptr i8, ptr %24, i64 81920, !dbg !90
  %35 = load <32 x float>, ptr %34, align 64, !dbg !90
  %36 = getelementptr i8, ptr %24, i64 98304, !dbg !90
  %37 = load <32 x float>, ptr %36, align 64, !dbg !90
  %38 = getelementptr i8, ptr %24, i64 114688, !dbg !90
  %39 = load <32 x float>, ptr %38, align 64, !dbg !90
  %40 = getelementptr i8, ptr %24, i64 131072, !dbg !90
  %41 = load <32 x float>, ptr %40, align 64, !dbg !90
  %42 = load float, ptr %4, align 64, !dbg !91
  %43 = insertelement <32 x float> poison, float %42, i64 0, !dbg !91
  %44 = shufflevector <32 x float> %43, <32 x float> poison, <32 x i32> zeroinitializer, !dbg !91
  %45 = tail call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %25, <32 x float> %44, <32 x float> zeroinitializer), !dbg !91
  %46 = load float, ptr %12, align 4, !dbg !91
  %47 = insertelement <32 x float> poison, float %46, i64 0, !dbg !91
  %48 = shufflevector <32 x float> %47, <32 x float> poison, <32 x i32> zeroinitializer, !dbg !91
  %49 = tail call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %27, <32 x float> %48, <32 x float> %45), !dbg !91
  %50 = load float, ptr %13, align 8, !dbg !91
  %51 = insertelement <32 x float> poison, float %50, i64 0, !dbg !91
  %52 = shufflevector <32 x float> %51, <32 x float> poison, <32 x i32> zeroinitializer, !dbg !91
  %53 = tail call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %29, <32 x float> %52, <32 x float> %49), !dbg !91
  %54 = load float, ptr %14, align 4, !dbg !91
  %55 = insertelement <32 x float> poison, float %54, i64 0, !dbg !91
  %56 = shufflevector <32 x float> %55, <32 x float> poison, <32 x i32> zeroinitializer, !dbg !91
  %57 = tail call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %31, <32 x float> %56, <32 x float> %53), !dbg !91
  %58 = load float, ptr %15, align 16, !dbg !91
  %59 = insertelement <32 x float> poison, float %58, i64 0, !dbg !91
  %60 = shufflevector <32 x float> %59, <32 x float> poison, <32 x i32> zeroinitializer, !dbg !91
  %61 = tail call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %33, <32 x float> %60, <32 x float> %57), !dbg !91
  %62 = load float, ptr %16, align 4, !dbg !91
  %63 = insertelement <32 x float> poison, float %62, i64 0, !dbg !91
  %64 = shufflevector <32 x float> %63, <32 x float> poison, <32 x i32> zeroinitializer, !dbg !91
  %65 = tail call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %35, <32 x float> %64, <32 x float> %61), !dbg !91
  %66 = load float, ptr %17, align 8, !dbg !91
  %67 = insertelement <32 x float> poison, float %66, i64 0, !dbg !91
  %68 = shufflevector <32 x float> %67, <32 x float> poison, <32 x i32> zeroinitializer, !dbg !91
  %69 = tail call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %37, <32 x float> %68, <32 x float> %65), !dbg !91
  %70 = load float, ptr %18, align 4, !dbg !91
  %71 = insertelement <32 x float> poison, float %70, i64 0, !dbg !91
  %72 = shufflevector <32 x float> %71, <32 x float> poison, <32 x i32> zeroinitializer, !dbg !91
  %73 = tail call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %39, <32 x float> %72, <32 x float> %69), !dbg !91
  %74 = load float, ptr %19, align 32, !dbg !91
  %75 = insertelement <32 x float> poison, float %74, i64 0, !dbg !91
  %76 = shufflevector <32 x float> %75, <32 x float> poison, <32 x i32> zeroinitializer, !dbg !91
  %77 = tail call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %41, <32 x float> %76, <32 x float> %73), !dbg !91
  %78 = getelementptr [4 x i8], ptr %8, i64 %23, !dbg !90
  store <32 x float> %77, ptr %78, align 64, !dbg !90
  br i1 %21, label %20, label %79, !dbg !90
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: write, target_mem0: none, target_mem1: none)
define internal noundef i32 @infer_dispatch_1_matmul_1x2x4096_f32(ptr noalias nonnull readnone align 16 captures(none) %0, ptr noalias noundef nonnull readonly align 16 captures(none) %1, ptr noalias nonnull readnone align 16 captures(none) %2) #0 !dbg !93 {
  ...
  %7 = getelementptr i8, ptr %6, i64 147456, !dbg !95
...
10:                                               ; preds = %3, %10
  ...
  %14 = load <2 x float>, ptr %13, align 64, !dbg !97
  ...
  %24 = or disjoint i64 %12, 4, !dbg !97
  %.idx26 = shl nuw nsw i64 %24, 3, !dbg !97
  %25 = getelementptr i8, ptr %7, i64 %.idx26, !dbg !97
  %26 = load <2 x float>, ptr %25, align 32, !dbg !97
  %27 = or disjoint i64 %12, 5, !dbg !97
  %.idx27 = shl nuw nsw i64 %27, 3, !dbg !97
  %28 = getelementptr i8, ptr %7, i64 %.idx27, !dbg !97
  %29 = load <2 x float>, ptr %28, align 8, !dbg !97
  %30 = or disjoint i64 %12, 6, !dbg !97
  %.idx28 = shl nuw nsw i64 %30, 3, !dbg !97
  %31 = getelementptr i8, ptr %7, i64 %.idx28, !dbg !97
  %32 = load <2 x float>, ptr %31, align 16, !dbg !97
  %33 = or disjoint i64 %12, 7, !dbg !97
  %.idx29 = shl nuw nsw i64 %33, 3, !dbg !97
  %34 = getelementptr i8, ptr %7, i64 %.idx29, !dbg !97
  %35 = load <2 x float>, ptr %34, align 8, !dbg !97
  %36 = or disjoint i64 %12, 8, !dbg !97
  %.idx30 = shl nuw nsw i64 %36, 3, !dbg !97
  %37 = getelementptr i8, ptr %7, i64 %.idx30, !dbg !97
  %38 = load <2 x float>, ptr %37, align 64, !dbg !97
  %39 = or disjoint i64 %12, 9, !dbg !97
  %.idx31 = shl nuw nsw i64 %39, 3, !dbg !97
  %40 = getelementptr i8, ptr %7, i64 %.idx31, !dbg !97
  %41 = load <2 x float>, ptr %40, align 8, !dbg !97
  %42 = or disjoint i64 %12, 10, !dbg !97
  %.idx32 = shl nuw nsw i64 %42, 3, !dbg !97
  %43 = getelementptr i8, ptr %7, i64 %.idx32, !dbg !97
  %44 = load <2 x float>, ptr %43, align 16, !dbg !97
  %45 = or disjoint i64 %12, 11, !dbg !97
  %.idx33 = shl nuw nsw i64 %45, 3, !dbg !97
  %46 = getelementptr i8, ptr %7, i64 %.idx33, !dbg !97
  %47 = load <2 x float>, ptr %46, align 8, !dbg !97
  %48 = or disjoint i64 %12, 12, !dbg !97
  %.idx34 = shl nuw nsw i64 %48, 3, !dbg !97
  %49 = getelementptr i8, ptr %7, i64 %.idx34, !dbg !97
  %50 = load <2 x float>, ptr %49, align 32, !dbg !97
  %51 = or disjoint i64 %12, 13, !dbg !97
  %.idx35 = shl nuw nsw i64 %51, 3, !dbg !97
  %52 = getelementptr i8, ptr %7, i64 %.idx35, !dbg !97
  %53 = load <2 x float>, ptr %52, align 8, !dbg !97
  %54 = or disjoint i64 %12, 14, !dbg !97
  %.idx36 = shl nuw nsw i64 %54, 3, !dbg !97
  %55 = getelementptr i8, ptr %7, i64 %.idx36, !dbg !97
  %56 = load <2 x float>, ptr %55, align 16, !dbg !97
  %57 = or disjoint i64 %12, 15, !dbg !97
  %.idx37 = shl nuw nsw i64 %57, 3, !dbg !97
  %58 = getelementptr i8, ptr %7, i64 %.idx37, !dbg !97
  %59 = load <2 x float>, ptr %58, align 8, !dbg !97
  %60 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %12, !dbg !98
  %61 = load float, ptr %60, align 64, !dbg !98
  %62 = insertelement <2 x float> poison, float %61, i64 0, !dbg !98
  %63 = shufflevector <2 x float> %62, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %64 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %63, <2 x float> %11), !dbg !98
  %65 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %15, !dbg !98
  %66 = load float, ptr %65, align 4, !dbg !98
  %67 = insertelement <2 x float> poison, float %66, i64 0, !dbg !98
  %68 = shufflevector <2 x float> %67, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %69 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> %68, <2 x float> %64), !dbg !98
  %70 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %18, !dbg !98
  %71 = load float, ptr %70, align 8, !dbg !98
  %72 = insertelement <2 x float> poison, float %71, i64 0, !dbg !98
  %73 = shufflevector <2 x float> %72, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %74 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %20, <2 x float> %73, <2 x float> %69), !dbg !98
  %75 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %21, !dbg !98
  %76 = load float, ptr %75, align 4, !dbg !98
  %77 = insertelement <2 x float> poison, float %76, i64 0, !dbg !98
  %78 = shufflevector <2 x float> %77, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %79 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %78, <2 x float> %74), !dbg !98
  %80 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %24, !dbg !98
  %81 = load float, ptr %80, align 16, !dbg !98
  %82 = insertelement <2 x float> poison, float %81, i64 0, !dbg !98
  %83 = shufflevector <2 x float> %82, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %84 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %26, <2 x float> %83, <2 x float> %79), !dbg !98
  %85 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %27, !dbg !98
  %86 = load float, ptr %85, align 4, !dbg !98
  %87 = insertelement <2 x float> poison, float %86, i64 0, !dbg !98
  %88 = shufflevector <2 x float> %87, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %89 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %88, <2 x float> %84), !dbg !98
  %90 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %30, !dbg !98
  %91 = load float, ptr %90, align 8, !dbg !98
  %92 = insertelement <2 x float> poison, float %91, i64 0, !dbg !98
  %93 = shufflevector <2 x float> %92, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %94 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %32, <2 x float> %93, <2 x float> %89), !dbg !98
  %95 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %33, !dbg !98
  %96 = load float, ptr %95, align 4, !dbg !98
  %97 = insertelement <2 x float> poison, float %96, i64 0, !dbg !98
  %98 = shufflevector <2 x float> %97, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %99 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %35, <2 x float> %98, <2 x float> %94), !dbg !98
  %100 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %36, !dbg !98
  %101 = load float, ptr %100, align 32, !dbg !98
  %102 = insertelement <2 x float> poison, float %101, i64 0, !dbg !98
  %103 = shufflevector <2 x float> %102, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %104 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %38, <2 x float> %103, <2 x float> %99), !dbg !98
  %105 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %39, !dbg !98
  %106 = load float, ptr %105, align 4, !dbg !98
  %107 = insertelement <2 x float> poison, float %106, i64 0, !dbg !98
  %108 = shufflevector <2 x float> %107, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %109 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %41, <2 x float> %108, <2 x float> %104), !dbg !98
  %110 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %42, !dbg !98
  %111 = load float, ptr %110, align 8, !dbg !98
  %112 = insertelement <2 x float> poison, float %111, i64 0, !dbg !98
  %113 = shufflevector <2 x float> %112, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %114 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %44, <2 x float> %113, <2 x float> %109), !dbg !98
  %115 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %45, !dbg !98
  %116 = load float, ptr %115, align 4, !dbg !98
  %117 = insertelement <2 x float> poison, float %116, i64 0, !dbg !98
  %118 = shufflevector <2 x float> %117, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %119 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %47, <2 x float> %118, <2 x float> %114), !dbg !98
  %120 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %48, !dbg !98
  %121 = load float, ptr %120, align 16, !dbg !98
  %122 = insertelement <2 x float> poison, float %121, i64 0, !dbg !98
  %123 = shufflevector <2 x float> %122, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %124 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %50, <2 x float> %123, <2 x float> %119), !dbg !98
  %125 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %51, !dbg !98
  %126 = load float, ptr %125, align 4, !dbg !98
  %127 = insertelement <2 x float> poison, float %126, i64 0, !dbg !98
  %128 = shufflevector <2 x float> %127, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %129 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %53, <2 x float> %128, <2 x float> %124), !dbg !98
  %130 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %54, !dbg !98
  %131 = load float, ptr %130, align 8, !dbg !98
  %132 = insertelement <2 x float> poison, float %131, i64 0, !dbg !98
  %133 = shufflevector <2 x float> %132, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %134 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %56, <2 x float> %133, <2 x float> %129), !dbg !98
  %135 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %57, !dbg !98
  %136 = load float, ptr %135, align 4, !dbg !98
  %137 = insertelement <2 x float> poison, float %136, i64 0, !dbg !98
  %138 = shufflevector <2 x float> %137, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %139 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %59, <2 x float> %138, <2 x float> %134), !dbg !98
  %140 = add nuw nsw i64 %12, 16, !dbg !97
  %141 = icmp samesign ult i64 %12, 4080, !dbg !97
  br i1 %141, label %10, label %142, !dbg !97

142:                                              ; preds = %10
  store <2 x float> %139, ptr %9, align 64, !dbg !98
  ret i32 0, !dbg !99
}
