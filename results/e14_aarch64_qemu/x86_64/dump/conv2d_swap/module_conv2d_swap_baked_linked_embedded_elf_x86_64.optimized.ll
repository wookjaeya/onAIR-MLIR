...
@0 = internal constant [25 x i8] c"conv2d_swap_baked_linked\00", align 1
...
@4 = internal constant [89 x i8] c"results/e14_aarch64_qemu/x86_64/dump/conv2d_swap/configured_module_infer_dispatch_0.mlir\00", align 1
@5 = internal constant [89 x i8] c"results/e14_aarch64_qemu/x86_64/dump/conv2d_swap/configured_module_infer_dispatch_1.mlir\00", align 1
@6 = internal constant [89 x i8] c"results/e14_aarch64_qemu/x86_64/dump/conv2d_swap/configured_module_infer_dispatch_2.mlir\00", align 1
@iree_hal_executable_library_query_v0_source_locations = internal constant [3 x %iree_hal_executable_source_location_v0_t] [%iree_hal_executable_source_location_v0_t { i32 3, i32 88, ptr @4 }, %iree_hal_executable_source_location_v0_t { i32 3, i32 88, ptr @5 }, %iree_hal_executable_source_location_v0_t { i32 3, i32 88, ptr @6 }]
...
42:                                               ; preds = %40
  ...
  %44 = fadd contract <4 x float> %43, <float 0xBFAA512F20000000, float 0xBFC51869A0000000, float 0x3F9125FCE0000000, float 0x3F86537A60000000>, !dbg !97
