...
@4 = internal constant [84 x i8] c"results/e14_aarch64_qemu/x86_64/dump/conv2d/configured_module_infer_dispatch_0.mlir\00", align 1
@5 = internal constant [84 x i8] c"results/e14_aarch64_qemu/x86_64/dump/conv2d/configured_module_infer_dispatch_1.mlir\00", align 1
@6 = internal constant [84 x i8] c"results/e14_aarch64_qemu/x86_64/dump/conv2d/configured_module_infer_dispatch_2.mlir\00", align 1
@iree_hal_executable_library_query_v0_source_locations = internal constant [3 x %iree_hal_executable_source_location_v0_t] [%iree_hal_executable_source_location_v0_t { i32 3, i32 83, ptr @4 }, %iree_hal_executable_source_location_v0_t { i32 3, i32 83, ptr @5 }, %iree_hal_executable_source_location_v0_t { i32 3, i32 83, ptr @6 }]
...
define internal noundef i32 @infer_dispatch_1_conv_4x4x8x3x3x4_f32(ptr noalias nonnull readnone align 16 captures(none) %0, ptr noalias noundef nonnull readonly align 16 captures(none) %1, ptr noalias noundef nonnull readonly align 16 captures(none) %2) #0 !dbg !100 {
  %4 = alloca [8 x float], align 64, !dbg !101
  %.elt21 = getelementptr inbounds nuw i8, ptr %1, i64 32, !dbg !102
  %.unpack22 = load ptr, ptr %.elt21, align 16, !dbg !102
  %5 = load ptr, ptr %.unpack22, align 8, !dbg !102
  call void @llvm.assume(i1 true) [ "align"(ptr %5, i64 64) ], !dbg !102
  %6 = getelementptr i8, ptr %.unpack22, i64 8, !dbg !103
  %7 = load ptr, ptr %6, align 8, !dbg !103
  %8 = getelementptr i8, ptr %7, i64 1024, !dbg !103
  call void @llvm.assume(i1 true) [ "align"(ptr %8, i64 64) ], !dbg !103
  %9 = getelementptr i8, ptr %.unpack22, i64 16, !dbg !104
  %10 = load ptr, ptr %9, align 8, !dbg !104
  %11 = load i32, ptr %2, align 16, !dbg !105
  %12 = zext i32 %11 to i64, !dbg !105
  %13 = lshr i64 %12, 2, !dbg !105
  %14 = and i64 %12, 3, !dbg !105
  store <8 x float> zeroinitializer, ptr %4, align 64, !dbg !106
  br label %15, !dbg !105

15:                                               ; preds = %3, %40
  %16 = phi i64 [ 0, %3 ], [ %41, %40 ]
  %17 = add nuw nsw i64 %16, %13, !dbg !105
  %.idx26 = mul nuw nsw i64 %17, 96
  %18 = getelementptr inbounds nuw i8, ptr %5, i64 %.idx26
  %.idx28 = mul nuw nsw i64 %16, 384
  %19 = getelementptr inbounds nuw i8, ptr %8, i64 %.idx28
  br label %20, !dbg !105

20:                                               ; preds = %15, %38
  %21 = phi i64 [ 0, %15 ], [ %39, %38 ]
  %22 = add nuw nsw i64 %21, %14, !dbg !105
  %.idx27 = shl nuw nsw i64 %22, 4
  %23 = getelementptr inbounds nuw i8, ptr %18, i64 %.idx27
  %.idx29 = shl nuw nsw i64 %21, 7
  %24 = getelementptr inbounds nuw i8, ptr %19, i64 %.idx29
  br label %.preheader, !dbg !105

.preheader:                                       ; preds = %20, %36
  %25 = phi i64 [ 0, %20 ], [ %37, %36 ]
  %invariant.gep = getelementptr [4 x i8], ptr %24, i64 %25, !dbg !105
  %26 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %25
  %.promoted = load float, ptr %26, align 4
  br label %27, !dbg !105

27:                                               ; preds = %.preheader, %27
  %28 = phi i64 [ 0, %.preheader ], [ %35, %27 ]
  %29 = phi float [ %.promoted, %.preheader ], [ %34, %27 ]
  %30 = getelementptr inbounds nuw [4 x i8], ptr %23, i64 %28, !dbg !105
  %31 = load float, ptr %30, align 4, !dbg !105
  %.idx30 = shl nuw nsw i64 %28, 5, !dbg !105
  %gep = getelementptr i8, ptr %invariant.gep, i64 %.idx30, !dbg !105
  %32 = load float, ptr %gep, align 4, !dbg !105
  %33 = fmul contract float %31, %32, !dbg !107
  %34 = fadd contract float %29, %33, !dbg !108
  %35 = add nuw nsw i64 %28, 1, !dbg !105
  %exitcond.not = icmp eq i64 %35, 4, !dbg !105
  br i1 %exitcond.not, label %36, label %27, !dbg !105

36:                                               ; preds = %27
  store float %34, ptr %26, align 4, !dbg !105
  %37 = add nuw nsw i64 %25, 1, !dbg !105
  %exitcond31.not = icmp eq i64 %37, 8, !dbg !105
  br i1 %exitcond31.not, label %38, label %.preheader, !dbg !105

38:                                               ; preds = %36
  %39 = add nuw nsw i64 %21, 1, !dbg !105
  %exitcond32.not = icmp eq i64 %39, 3, !dbg !105
  br i1 %exitcond32.not, label %40, label %20, !dbg !105

40:                                               ; preds = %38
  %41 = add nuw nsw i64 %16, 1, !dbg !105
  %exitcond33.not = icmp eq i64 %41, 3, !dbg !105
  br i1 %exitcond33.not, label %42, label %15, !dbg !105

42:                                               ; preds = %40
  %43 = getelementptr i8, ptr %10, i64 576, !dbg !104
  %44 = load <8 x float>, ptr %4, align 64, !dbg !109
  %.inv = fcmp ole <8 x float> %44, zeroinitializer, !dbg !110
  %45 = select <8 x i1> %.inv, <8 x float> zeroinitializer, <8 x float> %44, !dbg !110
  %.idx = shl nuw nsw i64 %13, 7, !dbg !110
  %46 = getelementptr i8, ptr %43, i64 %.idx, !dbg !110
  %.idx25 = shl nuw nsw i64 %14, 5, !dbg !110
  %47 = getelementptr i8, ptr %46, i64 %.idx25, !dbg !110
  store <8 x float> %45, ptr %47, align 4, !dbg !110
  ret i32 0, !dbg !111
}
...
10:                                               ; preds = %3, %10
  ...
  %14 = load <2 x float>, ptr %13, align 64, !dbg !116
  ...
  %24 = or disjoint i64 %12, 4, !dbg !116
  %.idx26 = shl nuw nsw i64 %24, 3, !dbg !116
  %25 = getelementptr i8, ptr %7, i64 %.idx26, !dbg !116
  %26 = load <2 x float>, ptr %25, align 32, !dbg !116
  %27 = or disjoint i64 %12, 5, !dbg !116
  %.idx27 = shl nuw nsw i64 %27, 3, !dbg !116
  %28 = getelementptr i8, ptr %7, i64 %.idx27, !dbg !116
  %29 = load <2 x float>, ptr %28, align 8, !dbg !116
  %30 = or disjoint i64 %12, 6, !dbg !116
  %.idx28 = shl nuw nsw i64 %30, 3, !dbg !116
  %31 = getelementptr i8, ptr %7, i64 %.idx28, !dbg !116
  %32 = load <2 x float>, ptr %31, align 16, !dbg !116
  %33 = or disjoint i64 %12, 7, !dbg !116
  %.idx29 = shl nuw nsw i64 %33, 3, !dbg !116
  %34 = getelementptr i8, ptr %7, i64 %.idx29, !dbg !116
  %35 = load <2 x float>, ptr %34, align 8, !dbg !116
  %36 = or disjoint i64 %12, 8, !dbg !116
  %.idx30 = shl nuw nsw i64 %36, 3, !dbg !116
  %37 = getelementptr i8, ptr %7, i64 %.idx30, !dbg !116
  %38 = load <2 x float>, ptr %37, align 64, !dbg !116
  %39 = or disjoint i64 %12, 9, !dbg !116
  %.idx31 = shl nuw nsw i64 %39, 3, !dbg !116
  %40 = getelementptr i8, ptr %7, i64 %.idx31, !dbg !116
  %41 = load <2 x float>, ptr %40, align 8, !dbg !116
  %42 = or disjoint i64 %12, 10, !dbg !116
  %.idx32 = shl nuw nsw i64 %42, 3, !dbg !116
  %43 = getelementptr i8, ptr %7, i64 %.idx32, !dbg !116
  %44 = load <2 x float>, ptr %43, align 16, !dbg !116
  %45 = or disjoint i64 %12, 11, !dbg !116
  %.idx33 = shl nuw nsw i64 %45, 3, !dbg !116
  %46 = getelementptr i8, ptr %7, i64 %.idx33, !dbg !116
  %47 = load <2 x float>, ptr %46, align 8, !dbg !116
  %48 = or disjoint i64 %12, 12, !dbg !116
  %.idx34 = shl nuw nsw i64 %48, 3, !dbg !116
  %49 = getelementptr i8, ptr %7, i64 %.idx34, !dbg !116
  %50 = load <2 x float>, ptr %49, align 32, !dbg !116
  %51 = or disjoint i64 %12, 13, !dbg !116
  %.idx35 = shl nuw nsw i64 %51, 3, !dbg !116
  %52 = getelementptr i8, ptr %7, i64 %.idx35, !dbg !116
  %53 = load <2 x float>, ptr %52, align 8, !dbg !116
  %54 = or disjoint i64 %12, 14, !dbg !116
  %.idx36 = shl nuw nsw i64 %54, 3, !dbg !116
  %55 = getelementptr i8, ptr %7, i64 %.idx36, !dbg !116
  %56 = load <2 x float>, ptr %55, align 16, !dbg !116
  %57 = or disjoint i64 %12, 15, !dbg !116
  %.idx37 = shl nuw nsw i64 %57, 3, !dbg !116
  %58 = getelementptr i8, ptr %7, i64 %.idx37, !dbg !116
  %59 = load <2 x float>, ptr %58, align 8, !dbg !116
  %60 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %12, !dbg !117
  %61 = load float, ptr %60, align 64, !dbg !117
  %62 = insertelement <2 x float> poison, float %61, i64 0, !dbg !117
  %63 = shufflevector <2 x float> %62, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %64 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %63, <2 x float> %11), !dbg !117
  %65 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %15, !dbg !117
  %66 = load float, ptr %65, align 4, !dbg !117
  %67 = insertelement <2 x float> poison, float %66, i64 0, !dbg !117
  %68 = shufflevector <2 x float> %67, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %69 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> %68, <2 x float> %64), !dbg !117
  %70 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %18, !dbg !117
  %71 = load float, ptr %70, align 8, !dbg !117
  %72 = insertelement <2 x float> poison, float %71, i64 0, !dbg !117
  %73 = shufflevector <2 x float> %72, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %74 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %20, <2 x float> %73, <2 x float> %69), !dbg !117
  %75 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %21, !dbg !117
  %76 = load float, ptr %75, align 4, !dbg !117
  %77 = insertelement <2 x float> poison, float %76, i64 0, !dbg !117
  %78 = shufflevector <2 x float> %77, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %79 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %78, <2 x float> %74), !dbg !117
  %80 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %24, !dbg !117
  %81 = load float, ptr %80, align 16, !dbg !117
  %82 = insertelement <2 x float> poison, float %81, i64 0, !dbg !117
  %83 = shufflevector <2 x float> %82, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %84 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %26, <2 x float> %83, <2 x float> %79), !dbg !117
  %85 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %27, !dbg !117
  %86 = load float, ptr %85, align 4, !dbg !117
  %87 = insertelement <2 x float> poison, float %86, i64 0, !dbg !117
  %88 = shufflevector <2 x float> %87, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %89 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %88, <2 x float> %84), !dbg !117
  %90 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %30, !dbg !117
  %91 = load float, ptr %90, align 8, !dbg !117
  %92 = insertelement <2 x float> poison, float %91, i64 0, !dbg !117
  %93 = shufflevector <2 x float> %92, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %94 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %32, <2 x float> %93, <2 x float> %89), !dbg !117
  %95 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %33, !dbg !117
  %96 = load float, ptr %95, align 4, !dbg !117
  %97 = insertelement <2 x float> poison, float %96, i64 0, !dbg !117
  %98 = shufflevector <2 x float> %97, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %99 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %35, <2 x float> %98, <2 x float> %94), !dbg !117
  %100 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %36, !dbg !117
  %101 = load float, ptr %100, align 32, !dbg !117
  %102 = insertelement <2 x float> poison, float %101, i64 0, !dbg !117
  %103 = shufflevector <2 x float> %102, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %104 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %38, <2 x float> %103, <2 x float> %99), !dbg !117
  %105 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %39, !dbg !117
  %106 = load float, ptr %105, align 4, !dbg !117
  %107 = insertelement <2 x float> poison, float %106, i64 0, !dbg !117
  %108 = shufflevector <2 x float> %107, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %109 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %41, <2 x float> %108, <2 x float> %104), !dbg !117
  %110 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %42, !dbg !117
  %111 = load float, ptr %110, align 8, !dbg !117
  %112 = insertelement <2 x float> poison, float %111, i64 0, !dbg !117
  %113 = shufflevector <2 x float> %112, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %114 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %44, <2 x float> %113, <2 x float> %109), !dbg !117
  %115 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %45, !dbg !117
  %116 = load float, ptr %115, align 4, !dbg !117
  %117 = insertelement <2 x float> poison, float %116, i64 0, !dbg !117
  %118 = shufflevector <2 x float> %117, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %119 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %47, <2 x float> %118, <2 x float> %114), !dbg !117
  %120 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %48, !dbg !117
  %121 = load float, ptr %120, align 16, !dbg !117
  %122 = insertelement <2 x float> poison, float %121, i64 0, !dbg !117
  %123 = shufflevector <2 x float> %122, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %124 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %50, <2 x float> %123, <2 x float> %119), !dbg !117
  %125 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %51, !dbg !117
  %126 = load float, ptr %125, align 4, !dbg !117
  %127 = insertelement <2 x float> poison, float %126, i64 0, !dbg !117
  %128 = shufflevector <2 x float> %127, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %129 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %53, <2 x float> %128, <2 x float> %124), !dbg !117
  %130 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %54, !dbg !117
  %131 = load float, ptr %130, align 8, !dbg !117
  %132 = insertelement <2 x float> poison, float %131, i64 0, !dbg !117
  %133 = shufflevector <2 x float> %132, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %134 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %56, <2 x float> %133, <2 x float> %129), !dbg !117
  %135 = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %57, !dbg !117
  %136 = load float, ptr %135, align 4, !dbg !117
  %137 = insertelement <2 x float> poison, float %136, i64 0, !dbg !117
  %138 = shufflevector <2 x float> %137, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !117
  %139 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %59, <2 x float> %138, <2 x float> %134), !dbg !117
  %140 = add nuw nsw i64 %12, 16, !dbg !116
  %141 = icmp samesign ult i64 %12, 112, !dbg !116
  br i1 %141, label %10, label %142, !dbg !116

142:                                              ; preds = %10
  store <2 x float> %139, ptr %9, align 64, !dbg !117
  ret i32 0, !dbg !118
}
