...
19:                                               ; preds = %73, %3
  %20 = phi i64 [ %84, %73 ], [ 0, %3 ], !dbg !90
  %21 = icmp slt i64 %20, 64, !dbg !90
  br i1 %21, label %22, label %85, !dbg !90
...
24:                                               ; preds = %28, %22
  %25 = phi i64 [ %72, %28 ], [ 0, %22 ], !dbg !90
  %26 = phi <8 x float> [ %71, %28 ], [ zeroinitializer, %22 ], !dbg !90
  %27 = icmp slt i64 %25, 8, !dbg !90
  br i1 %27, label %28, label %73, !dbg !90

28:                                               ; preds = %24
  %29 = mul i64 %25, 4096, !dbg !90
  %30 = add i64 %29, %23, !dbg !90
  %31 = getelementptr float, ptr %10, i64 %30, !dbg !90
  %32 = load <8 x float>, ptr %31, align 4, !dbg !90
  %33 = add i64 %25, 1, !dbg !90
  %34 = mul i64 %33, 4096, !dbg !90
  %35 = add i64 %34, %23, !dbg !90
  %36 = getelementptr float, ptr %10, i64 %35, !dbg !90
  %37 = load <8 x float>, ptr %36, align 4, !dbg !90
  %38 = add i64 %25, 2, !dbg !90
  %39 = mul i64 %38, 4096, !dbg !90
  %40 = add i64 %39, %23, !dbg !90
  %41 = getelementptr float, ptr %10, i64 %40, !dbg !90
  %42 = load <8 x float>, ptr %41, align 4, !dbg !90
  %43 = add i64 %25, 3, !dbg !90
  %44 = mul i64 %43, 4096, !dbg !90
  %45 = add i64 %44, %23, !dbg !90
  %46 = getelementptr float, ptr %10, i64 %45, !dbg !90
  %47 = load <8 x float>, ptr %46, align 4, !dbg !90
  %48 = add nuw nsw i64 0, %25, !dbg !91
  %49 = getelementptr inbounds nuw float, ptr %6, i64 %48, !dbg !91
  %50 = load float, ptr %49, align 4, !dbg !91
  %51 = insertelement <8 x float> poison, float %50, i32 0, !dbg !91
  %52 = shufflevector <8 x float> %51, <8 x float> poison, <8 x i32> zeroinitializer, !dbg !91
  %53 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %32, <8 x float> %52, <8 x float> %26), !dbg !91
  %54 = add nuw nsw i64 0, %33, !dbg !91
  %55 = getelementptr inbounds nuw float, ptr %6, i64 %54, !dbg !91
  %56 = load float, ptr %55, align 4, !dbg !91
  %57 = insertelement <8 x float> poison, float %56, i32 0, !dbg !91
  %58 = shufflevector <8 x float> %57, <8 x float> poison, <8 x i32> zeroinitializer, !dbg !91
  %59 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %37, <8 x float> %58, <8 x float> %53), !dbg !91
  %60 = add nuw nsw i64 0, %38, !dbg !91
  %61 = getelementptr inbounds nuw float, ptr %6, i64 %60, !dbg !91
  %62 = load float, ptr %61, align 4, !dbg !91
  %63 = insertelement <8 x float> poison, float %62, i32 0, !dbg !91
  %64 = shufflevector <8 x float> %63, <8 x float> poison, <8 x i32> zeroinitializer, !dbg !91
  %65 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %42, <8 x float> %64, <8 x float> %59), !dbg !91
  %66 = add nuw nsw i64 0, %43, !dbg !91
  %67 = getelementptr inbounds nuw float, ptr %6, i64 %66, !dbg !91
  %68 = load float, ptr %67, align 4, !dbg !91
  %69 = insertelement <8 x float> poison, float %68, i32 0, !dbg !91
  %70 = shufflevector <8 x float> %69, <8 x float> poison, <8 x i32> zeroinitializer, !dbg !91
  %71 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %47, <8 x float> %70, <8 x float> %65), !dbg !91
  %72 = add i64 %25, 4, !dbg !90
  br label %24, !dbg !90

73:                                               ; preds = %24
  %74 = add i64 32768, %23, !dbg !90
  %75 = getelementptr float, ptr %10, i64 %74, !dbg !90
  %76 = load <8 x float>, ptr %75, align 4, !dbg !90
  %77 = getelementptr inbounds nuw float, ptr %6, i64 8, !dbg !91
  %78 = load float, ptr %77, align 4, !dbg !91
  %79 = insertelement <8 x float> poison, float %78, i32 0, !dbg !91
  %80 = shufflevector <8 x float> %79, <8 x float> poison, <8 x i32> zeroinitializer, !dbg !91
  %81 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %76, <8 x float> %80, <8 x float> %26), !dbg !91
  %82 = add i64 0, %23, !dbg !90
  %83 = getelementptr float, ptr %14, i64 %82, !dbg !90
  store <8 x float> %81, ptr %83, align 4, !dbg !90
  %84 = add i64 %20, 8, !dbg !90
  br label %19, !dbg !90
...
16:                                               ; preds = %20, %3
  %17 = phi i64 [ %64, %20 ], [ 0, %3 ], !dbg !97
  %18 = phi <2 x float> [ %63, %20 ], [ zeroinitializer, %3 ], !dbg !97
  %19 = icmp slt i64 %17, 4096, !dbg !97
  br i1 %19, label %20, label %65, !dbg !97
...
20:                                               ; preds = %16
  ...
  %40 = add nuw nsw i64 0, %17, !dbg !98
  %41 = getelementptr inbounds nuw float, ptr %6, i64 %40, !dbg !98
  %42 = load float, ptr %41, align 4, !dbg !98
  %43 = insertelement <2 x float> poison, float %42, i32 0, !dbg !98
  %44 = shufflevector <2 x float> %43, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %45 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %24, <2 x float> %44, <2 x float> %18), !dbg !98
  %46 = add nuw nsw i64 0, %25, !dbg !98
  %47 = getelementptr inbounds nuw float, ptr %6, i64 %46, !dbg !98
  %48 = load float, ptr %47, align 4, !dbg !98
  %49 = insertelement <2 x float> poison, float %48, i32 0, !dbg !98
  %50 = shufflevector <2 x float> %49, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %51 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %50, <2 x float> %45), !dbg !98
  %52 = add nuw nsw i64 0, %30, !dbg !98
  %53 = getelementptr inbounds nuw float, ptr %6, i64 %52, !dbg !98
  %54 = load float, ptr %53, align 4, !dbg !98
  %55 = insertelement <2 x float> poison, float %54, i32 0, !dbg !98
  %56 = shufflevector <2 x float> %55, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %57 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %34, <2 x float> %56, <2 x float> %51), !dbg !98
  %58 = add nuw nsw i64 0, %35, !dbg !98
  %59 = getelementptr inbounds nuw float, ptr %6, i64 %58, !dbg !98
  %60 = load float, ptr %59, align 4, !dbg !98
  %61 = insertelement <2 x float> poison, float %60, i32 0, !dbg !98
  %62 = shufflevector <2 x float> %61, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !98
  %63 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %39, <2 x float> %62, <2 x float> %57), !dbg !98
  %64 = add i64 %17, 4, !dbg !97
  br label %16, !dbg !97

65:                                               ; preds = %16
  %66 = getelementptr float, ptr %15, i64 0, !dbg !98
  store <2 x float> %18, ptr %66, align 4, !dbg !98
  ret i32 0, !dbg !99
}
