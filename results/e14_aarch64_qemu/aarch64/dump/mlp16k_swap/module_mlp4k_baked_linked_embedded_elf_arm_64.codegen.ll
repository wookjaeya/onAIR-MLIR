...
@3 = private constant [90 x i8] c"results/e14_aarch64_qemu/aarch64/dump/mlp16k_swap/configured_module_infer_dispatch_0.mlir\00", align 1
@4 = private constant [90 x i8] c"results/e14_aarch64_qemu/aarch64/dump/mlp16k_swap/configured_module_infer_dispatch_1.mlir\00", align 1
@iree_hal_executable_library_query_v0_source_locations = private constant [2 x %iree_hal_executable_source_location_v0_t] [%iree_hal_executable_source_location_v0_t { i32 3, i32 89, ptr @3 }, %iree_hal_executable_source_location_v0_t { i32 3, i32 89, ptr @4 }]
...
define internal i32 @infer_dispatch_0_matmul_1x4096x9_f32(ptr noalias noundef nonnull align 16 %0, ptr noalias noundef nonnull align 16 %1, ptr noalias noundef nonnull align 16 %2) #0 !dbg !5 {
...
19:                                               ; preds = %73, %3
  %20 = phi i64 [ %84, %73 ], [ 0, %3 ], !dbg !84
  %21 = icmp slt i64 %20, 64, !dbg !84
  br i1 %21, label %22, label %85, !dbg !84
...
24:                                               ; preds = %28, %22
  %25 = phi i64 [ %72, %28 ], [ 0, %22 ], !dbg !84
  %26 = phi <8 x float> [ %71, %28 ], [ zeroinitializer, %22 ], !dbg !84
  %27 = icmp slt i64 %25, 8, !dbg !84
  br i1 %27, label %28, label %73, !dbg !84

28:                                               ; preds = %24
  %29 = mul i64 %25, 4096, !dbg !84
  %30 = add i64 %29, %23, !dbg !84
  %31 = getelementptr float, ptr %10, i64 %30, !dbg !84
  %32 = load <8 x float>, ptr %31, align 4, !dbg !84
  %33 = add i64 %25, 1, !dbg !84
  %34 = mul i64 %33, 4096, !dbg !84
  %35 = add i64 %34, %23, !dbg !84
  %36 = getelementptr float, ptr %10, i64 %35, !dbg !84
  %37 = load <8 x float>, ptr %36, align 4, !dbg !84
  %38 = add i64 %25, 2, !dbg !84
  %39 = mul i64 %38, 4096, !dbg !84
  %40 = add i64 %39, %23, !dbg !84
  %41 = getelementptr float, ptr %10, i64 %40, !dbg !84
  %42 = load <8 x float>, ptr %41, align 4, !dbg !84
  %43 = add i64 %25, 3, !dbg !84
  %44 = mul i64 %43, 4096, !dbg !84
  %45 = add i64 %44, %23, !dbg !84
  %46 = getelementptr float, ptr %10, i64 %45, !dbg !84
  %47 = load <8 x float>, ptr %46, align 4, !dbg !84
  %48 = add nuw nsw i64 0, %25, !dbg !85
  %49 = getelementptr inbounds nuw float, ptr %6, i64 %48, !dbg !85
  %50 = load float, ptr %49, align 4, !dbg !85
  %51 = insertelement <8 x float> poison, float %50, i32 0, !dbg !85
  %52 = shufflevector <8 x float> %51, <8 x float> poison, <8 x i32> zeroinitializer, !dbg !85
  %53 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %32, <8 x float> %52, <8 x float> %26), !dbg !85
  %54 = add nuw nsw i64 0, %33, !dbg !85
  %55 = getelementptr inbounds nuw float, ptr %6, i64 %54, !dbg !85
  %56 = load float, ptr %55, align 4, !dbg !85
  %57 = insertelement <8 x float> poison, float %56, i32 0, !dbg !85
  %58 = shufflevector <8 x float> %57, <8 x float> poison, <8 x i32> zeroinitializer, !dbg !85
  %59 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %37, <8 x float> %58, <8 x float> %53), !dbg !85
  %60 = add nuw nsw i64 0, %38, !dbg !85
  %61 = getelementptr inbounds nuw float, ptr %6, i64 %60, !dbg !85
  %62 = load float, ptr %61, align 4, !dbg !85
  %63 = insertelement <8 x float> poison, float %62, i32 0, !dbg !85
  %64 = shufflevector <8 x float> %63, <8 x float> poison, <8 x i32> zeroinitializer, !dbg !85
  %65 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %42, <8 x float> %64, <8 x float> %59), !dbg !85
  %66 = add nuw nsw i64 0, %43, !dbg !85
  %67 = getelementptr inbounds nuw float, ptr %6, i64 %66, !dbg !85
  %68 = load float, ptr %67, align 4, !dbg !85
  %69 = insertelement <8 x float> poison, float %68, i32 0, !dbg !85
  %70 = shufflevector <8 x float> %69, <8 x float> poison, <8 x i32> zeroinitializer, !dbg !85
  %71 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %47, <8 x float> %70, <8 x float> %65), !dbg !85
  %72 = add i64 %25, 4, !dbg !84
  br label %24, !dbg !84

73:                                               ; preds = %24
  %74 = add i64 32768, %23, !dbg !84
  %75 = getelementptr float, ptr %10, i64 %74, !dbg !84
  %76 = load <8 x float>, ptr %75, align 4, !dbg !84
  %77 = getelementptr inbounds nuw float, ptr %6, i64 8, !dbg !85
  %78 = load float, ptr %77, align 4, !dbg !85
  %79 = insertelement <8 x float> poison, float %78, i32 0, !dbg !85
  %80 = shufflevector <8 x float> %79, <8 x float> poison, <8 x i32> zeroinitializer, !dbg !85
  %81 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %76, <8 x float> %80, <8 x float> %26), !dbg !85
  %82 = add i64 0, %23, !dbg !84
  %83 = getelementptr float, ptr %14, i64 %82, !dbg !84
  store <8 x float> %81, ptr %83, align 4, !dbg !84
  %84 = add i64 %20, 8, !dbg !84
  br label %19, !dbg !84
...
define internal i32 @infer_dispatch_1_matmul_1x2x4096_f32(ptr noalias noundef nonnull align 16 %0, ptr noalias noundef nonnull align 16 %1, ptr noalias noundef nonnull align 16 %2) #0 !dbg !87 {
  ...
  %11 = getelementptr float, ptr %10, i64 36864, !dbg !89
...
16:                                               ; preds = %20, %3
  %17 = phi i64 [ %64, %20 ], [ 0, %3 ], !dbg !91
  %18 = phi <2 x float> [ %63, %20 ], [ zeroinitializer, %3 ], !dbg !91
  %19 = icmp slt i64 %17, 4096, !dbg !91
  br i1 %19, label %20, label %65, !dbg !91
...
20:                                               ; preds = %16
  ...
  %40 = add nuw nsw i64 0, %17, !dbg !92
  %41 = getelementptr inbounds nuw float, ptr %6, i64 %40, !dbg !92
  %42 = load float, ptr %41, align 4, !dbg !92
  %43 = insertelement <2 x float> poison, float %42, i32 0, !dbg !92
  %44 = shufflevector <2 x float> %43, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !92
  %45 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %24, <2 x float> %44, <2 x float> %18), !dbg !92
  %46 = add nuw nsw i64 0, %25, !dbg !92
  %47 = getelementptr inbounds nuw float, ptr %6, i64 %46, !dbg !92
  %48 = load float, ptr %47, align 4, !dbg !92
  %49 = insertelement <2 x float> poison, float %48, i32 0, !dbg !92
  %50 = shufflevector <2 x float> %49, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !92
  %51 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %29, <2 x float> %50, <2 x float> %45), !dbg !92
  %52 = add nuw nsw i64 0, %30, !dbg !92
  %53 = getelementptr inbounds nuw float, ptr %6, i64 %52, !dbg !92
  %54 = load float, ptr %53, align 4, !dbg !92
  %55 = insertelement <2 x float> poison, float %54, i32 0, !dbg !92
  %56 = shufflevector <2 x float> %55, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !92
  %57 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %34, <2 x float> %56, <2 x float> %51), !dbg !92
  %58 = add nuw nsw i64 0, %35, !dbg !92
  %59 = getelementptr inbounds nuw float, ptr %6, i64 %58, !dbg !92
  %60 = load float, ptr %59, align 4, !dbg !92
  %61 = insertelement <2 x float> poison, float %60, i32 0, !dbg !92
  %62 = shufflevector <2 x float> %61, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !92
  %63 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %39, <2 x float> %62, <2 x float> %57), !dbg !92
  %64 = add i64 %17, 4, !dbg !91
  br label %16, !dbg !91

65:                                               ; preds = %16
  %66 = getelementptr float, ptr %15, i64 0, !dbg !92
  store <2 x float> %18, ptr %66, align 4, !dbg !92
  ret i32 0, !dbg !93
}
...
!1 = !DIFile(filename: "configured_module_infer_dispatch_0.mlir", directory: "results/e14_aarch64_qemu/aarch64/dump/mlp16k_swap")
...
!3 = !DIFile(filename: "configured_module_infer_dispatch_1.mlir", directory: "results/e14_aarch64_qemu/aarch64/dump/mlp16k_swap")
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = distinct !DISubprogram(name: "infer_dispatch_0_matmul_1x4096x9_f32", linkageName: "infer_dispatch_0_matmul_1x4096x9_f32", scope: !1, file: !1, line: 1, type: !6, scopeLine: 1, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0)
...
!87 = distinct !DISubprogram(name: "infer_dispatch_1_matmul_1x2x4096_f32", linkageName: "infer_dispatch_1_matmul_1x2x4096_f32", scope: !3, file: !3, line: 1, type: !6, scopeLine: 1, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2)
