...
@3 = internal constant [90 x i8] c"results/e14_aarch64_qemu/aarch64/dump/mlp16k_swap/configured_module_infer_dispatch_0.mlir\00", align 1
@4 = internal constant [90 x i8] c"results/e14_aarch64_qemu/aarch64/dump/mlp16k_swap/configured_module_infer_dispatch_1.mlir\00", align 1
@iree_hal_executable_library_query_v0_source_locations = internal constant [2 x %iree_hal_executable_source_location_v0_t] [%iree_hal_executable_source_location_v0_t { i32 3, i32 89, ptr @3 }, %iree_hal_executable_source_location_v0_t { i32 3, i32 89, ptr @4 }]
...
16:                                               ; preds = %13, %16
  ...
  %.idx = shl nuw nsw i64 %19, 14, !dbg !90
  ...
  %.idx24 = shl nuw nsw i64 %21, 14, !dbg !90
  ...
  %.idx25 = shl nuw nsw i64 %23, 14, !dbg !90
  ...
  %.idx26 = shl nuw nsw i64 %25, 14, !dbg !90
...
47:                                               ; preds = %16
  %48 = getelementptr i8, ptr %invariant.gep, i64 131072, !dbg !90
...
10:                                               ; preds = %3, %10
  ...
  %45 = icmp samesign ult i64 %12, 4092, !dbg !97
