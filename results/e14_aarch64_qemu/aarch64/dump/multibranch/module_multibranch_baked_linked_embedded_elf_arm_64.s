...
.Lfunc_begin0:
	.file	1 "results/e14_aarch64_qemu/aarch64/dump/multibranch" "configured_module_infer_dispatch_0.mlir"
	.loc	1 1 0
	.cfi_startproc
	stp	x29, x30, [sp, #-16]!
	mov	x29, sp
...
.Lfunc_begin1:
	.file	2 "results/e14_aarch64_qemu/aarch64/dump/multibranch" "configured_module_infer_dispatch_1.mlir"
	.loc	2 1 0
	.cfi_startproc
	stp	x29, x30, [sp, #-16]!
	mov	x29, sp
...
.Lfunc_begin2:
	.file	3 "results/e14_aarch64_qemu/aarch64/dump/multibranch" "configured_module_infer_dispatch_2.mlir"
	.loc	3 1 0
	.cfi_startproc
	stp	x29, x30, [sp, #-16]!
	mov	x29, sp
...
.Lfunc_begin3:
	.file	4 "results/e14_aarch64_qemu/aarch64/dump/multibranch" "configured_module_infer_dispatch_3.mlir"
	.loc	4 1 0
	.cfi_startproc
	stp	x29, x30, [sp, #-16]!
	mov	x29, sp
...
__unnamed_1:
	.asciz	"multibranch_baked_linked"
	.size	__unnamed_1, 25
...
__unnamed_6:
	.asciz	"results/e14_aarch64_qemu/aarch64/dump/multibranch/configured_module_infer_dispatch_0.mlir"
	.size	__unnamed_6, 90

	.type	__unnamed_7,@object
	.section	.rodata.__unnamed_7,"a",@progbits
__unnamed_7:
	.asciz	"results/e14_aarch64_qemu/aarch64/dump/multibranch/configured_module_infer_dispatch_1.mlir"
	.size	__unnamed_7, 90

	.type	__unnamed_8,@object
	.section	.rodata.__unnamed_8,"a",@progbits
__unnamed_8:
	.asciz	"results/e14_aarch64_qemu/aarch64/dump/multibranch/configured_module_infer_dispatch_2.mlir"
	.size	__unnamed_8, 90

	.type	__unnamed_9,@object
	.section	.rodata.__unnamed_9,"a",@progbits
__unnamed_9:
	.asciz	"results/e14_aarch64_qemu/aarch64/dump/multibranch/configured_module_infer_dispatch_3.mlir"
	.size	__unnamed_9, 90
...
.Linfo_string2:
	.asciz	"results/e14_aarch64_qemu/aarch64/dump/multibranch"
.Linfo_string3:
