...
.Lfunc_begin0:
	.file	1 "results/e14_aarch64_qemu/aarch64/dump/mlp16k" "configured_module_infer_dispatch_0.mlir"
	.loc	1 1 0
	.cfi_startproc
	stp	x29, x30, [sp, #-16]!
	mov	x29, sp
...
.LBB0_2:
	.loc	1 18 8
	add	x17, x14, x15, lsl #16
	.loc	1 1 1 is_stmt 1
	ldr	s2, [x8, x15, lsl #2]
	.loc	1 18 8
	ldp	q4, q3, [x17]
	orr	x17, x15, #0x1
	add	x0, x14, x17, lsl #16
	.loc	1 1 1
...
.Lfunc_begin1:
	.file	2 "results/e14_aarch64_qemu/aarch64/dump/mlp16k" "configured_module_infer_dispatch_1.mlir"
	.loc	2 1 0 is_stmt 1
	.cfi_startproc
	stp	x29, x30, [sp, #-16]!
	mov	x29, sp
...
iree_hal_executable_library_query_v0_funcs:
	.xword	infer_dispatch_0_matmul_1x16384x9_f32
	.xword	infer_dispatch_1_matmul_1x2x16384_f32
...
__unnamed_4:
	.asciz	"results/e14_aarch64_qemu/aarch64/dump/mlp16k/configured_module_infer_dispatch_0.mlir"
	.size	__unnamed_4, 85

	.type	__unnamed_5,@object
	.section	.rodata.__unnamed_5,"a",@progbits
__unnamed_5:
	.asciz	"results/e14_aarch64_qemu/aarch64/dump/mlp16k/configured_module_infer_dispatch_1.mlir"
	.size	__unnamed_5, 85
...
iree_hal_executable_library_query_v0_stage_location_tables:
	.word	0
	.zero	4
	.xword	iree_hal_executable_library_query_v0_infer_dispatch_0_matmul_1x16384x9_f32_stage_names
	.xword	iree_hal_executable_library_query_v0_infer_dispatch_0_matmul_1x16384x9_f32_stage_source_locations
	.word	0
	.zero	4
	.xword	iree_hal_executable_library_query_v0_infer_dispatch_1_matmul_1x2x16384_f32_stage_names
	.xword	iree_hal_executable_library_query_v0_infer_dispatch_1_matmul_1x2x16384_f32_stage_source_locations
...
.Linfo_string2:
	.asciz	"results/e14_aarch64_qemu/aarch64/dump/mlp16k"
.Linfo_string3:
