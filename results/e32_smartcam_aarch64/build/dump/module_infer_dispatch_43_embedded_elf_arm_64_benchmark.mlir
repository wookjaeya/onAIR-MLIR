module {
  ...
  util.global private mutable @infer_dispatch_43_embedded_elf_arm_64_infer_dispatch_43_matmul_like_960x7x7x160_f32_buffer : !hal.buffer
  util.initializer {
    ...
    util.global.store %buffer, @infer_dispatch_43_embedded_elf_arm_64_infer_dispatch_43_matmul_like_960x7x7x160_f32_buffer : !hal.buffer
    util.return
  }
  util.func public @infer_dispatch_43_embedded_elf_arm_64_infer_dispatch_43_matmul_like_960x7x7x160_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %infer_dispatch_43_embedded_elf_arm_64_infer_dispatch_43_matmul_like_960x7x7x160_f32_buffer = util.global.load @infer_dispatch_43_embedded_elf_arm_64_infer_dispatch_43_matmul_like_960x7x7x160_f32_buffer : !hal.buffer
    ...
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@infer_dispatch_43::@embedded_elf_arm_64::@infer_dispatch_43_matmul_like_960x7x7x160_f32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@infer_dispatch_43) : !hal.executable
    %ordinal = hal.executable.export.ordinal target(@infer_dispatch_43::@embedded_elf_arm_64::@infer_dispatch_43_matmul_like_960x7x7x160_f32) : index
    ...
    scf.for %arg1 = %c0 to %0 step %c1 {
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) constants([%c31360_i32, %c2867200_i32, %c8788352_i32, %c62720_i32]) bindings([
        (%infer_dispatch_43_embedded_elf_arm_64_infer_dispatch_43_matmul_like_960x7x7x160_f32_buffer : !hal.buffer)[%c0, %c8779968], 
        (%infer_dispatch_43_embedded_elf_arm_64_infer_dispatch_43_matmul_like_960x7x7x160_f32_buffer : !hal.buffer)[%c8780032, %c8840704], 
        (%infer_dispatch_43_embedded_elf_arm_64_infer_dispatch_43_matmul_like_960x7x7x160_f32_buffer : !hal.buffer)[%c17620736, %c8779968]
      ]) flags("None")
