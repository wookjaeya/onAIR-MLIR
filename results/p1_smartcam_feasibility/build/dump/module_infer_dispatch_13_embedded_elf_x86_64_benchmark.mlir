module {
    ...
    hal.executable.variant public @embedded_elf_x86_64 target(<"llvm-cpu", "embedded-elf-x86_64", {cpu = "generic", cpu_features = "", data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", iree.encoding.resolver = #iree_cpu.cpu_encoding_resolver<>, max_stack_allocation_size = 32768 : i64, native_vector_size = 16 : i64, target_triple = "x86_64-unknown-unknown-eabi-elf"}>) {
      ...
      builtin.module {
        func.func @infer_dispatch_13_matmul_like_192x28x28x32_f32() attributes {translation_info = #iree_codegen.translation_info<pipeline = CPUDoubleTilingExpert, {enable_loop_peeling}>} {
          ...
          %15 = linalg.fill {lowering_config = #iree_cpu.lowering_config<cache_parallel = [24, 14, 28], vector_common_parallel = [1, 1, 1]>} ins(%cst_0 : f32) outs(%14 : tensor<192x28x28xf32>) -> tensor<192x28x28xf32>
  ...
  util.global private mutable @infer_dispatch_13_embedded_elf_x86_64_infer_dispatch_13_matmul_like_192x28x28x32_f32_buffer : !hal.buffer
  util.initializer {
    ...
    util.global.store %buffer, @infer_dispatch_13_embedded_elf_x86_64_infer_dispatch_13_matmul_like_192x28x28x32_f32_buffer : !hal.buffer
    util.return
  }
  util.func public @infer_dispatch_13_embedded_elf_x86_64_infer_dispatch_13_matmul_like_192x28x28x32_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %infer_dispatch_13_embedded_elf_x86_64_infer_dispatch_13_matmul_like_192x28x28x32_f32_buffer = util.global.load @infer_dispatch_13_embedded_elf_x86_64_infer_dispatch_13_matmul_like_192x28x28x32_f32_buffer : !hal.buffer
    ...
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@infer_dispatch_13::@embedded_elf_x86_64::@infer_dispatch_13_matmul_like_192x28x28x32_f32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@infer_dispatch_13) : !hal.executable
    %ordinal = hal.executable.export.ordinal target(@infer_dispatch_13::@embedded_elf_x86_64::@infer_dispatch_13_matmul_like_192x28x28x32_f32) : index
    ...
    scf.for %arg1 = %c0 to %0 step %c1 {
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) constants([%c0_i32, %c8347648_i32, %c8781696_i32]) bindings([
        (%infer_dispatch_13_embedded_elf_x86_64_infer_dispatch_13_matmul_like_192x28x28x32_f32_buffer : !hal.buffer)[%c0, %c8779968], 
        (%infer_dispatch_13_embedded_elf_x86_64_infer_dispatch_13_matmul_like_192x28x28x32_f32_buffer : !hal.buffer)[%c8780032, %c8840704], 
        (%infer_dispatch_13_embedded_elf_x86_64_infer_dispatch_13_matmul_like_192x28x28x32_f32_buffer : !hal.buffer)[%c17620736, %c8779968]
      ]) flags("None")
