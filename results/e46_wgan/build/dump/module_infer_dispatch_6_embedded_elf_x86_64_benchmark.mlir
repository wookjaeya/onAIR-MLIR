module {
  ...
  hal.executable private @infer_dispatch_6 {
    hal.executable.variant public @embedded_elf_x86_64 target(<"llvm-cpu", "embedded-elf-x86_64", {cpu = "generic", cpu_features = "", data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", iree.encoding.resolver = #iree_cpu.cpu_encoding_resolver<>, max_stack_allocation_size = 32768 : i64, native_vector_size = 16 : i64, target_triple = "x86_64-unknown-unknown-eabi-elf"}>) {
      ...
      builtin.module {
        func.func @infer_dispatch_6_conv_128x224x224x128x3x3_f32() attributes {translation_info = #iree_codegen.translation_info<pipeline = CPUDoubleTilingExpert>} {
  ...
  util.global private mutable @infer_dispatch_6_embedded_elf_x86_64_infer_dispatch_6_conv_128x224x224x128x3x3_f32_buffer : !hal.buffer
  util.initializer {
    ...
    util.global.store %buffer, @infer_dispatch_6_embedded_elf_x86_64_infer_dispatch_6_conv_128x224x224x128x3x3_f32_buffer : !hal.buffer
    util.return
  }
  util.func public @infer_dispatch_6_embedded_elf_x86_64_infer_dispatch_6_conv_128x224x224x128x3x3_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    ...
    %infer_dispatch_6_embedded_elf_x86_64_infer_dispatch_6_conv_128x224x224x128x3x3_f32_buffer = util.global.load @infer_dispatch_6_embedded_elf_x86_64_infer_dispatch_6_conv_128x224x224x128x3x3_f32_buffer : !hal.buffer
    ...
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@infer_dispatch_6::@embedded_elf_x86_64::@infer_dispatch_6_conv_128x224x224x128x3x3_f32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@infer_dispatch_6) : !hal.executable
    %ordinal = hal.executable.export.ordinal target(@infer_dispatch_6::@embedded_elf_x86_64::@infer_dispatch_6_conv_128x224x224x128x3x3_f32) : index
    ...
    scf.for %arg1 = %c0 to %0 step %c1 {
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) constants([%c32112640_i32, %c6422528_i32, %c295296_i32, %c885120_i32, %c58263552_i32]) bindings([
        (%infer_dispatch_6_embedded_elf_x86_64_infer_dispatch_6_conv_128x224x224x128x3x3_f32_buffer : !hal.buffer)[%c0, %c130178560], 
        (%infer_dispatch_6_embedded_elf_x86_64_infer_dispatch_6_conv_128x224x224x128x3x3_f32_buffer : !hal.buffer)[%c130178560, %c4283648], 
        (%infer_dispatch_6_embedded_elf_x86_64_infer_dispatch_6_conv_128x224x224x128x3x3_f32_buffer : !hal.buffer)[%c134462208, %c130178560]
      ]) flags("None")
