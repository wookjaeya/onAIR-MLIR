...
python3 harness/contract_negative_tests.py  # 계약 도구 fail-closed 회귀·음성·구조적 추출기 일치·크로스체크 배선·과잉거부·fail-open·불변식 회귀 시험 (fresh clone 142/142+1 SKIP)
...
`contract_negative_tests.py`를 실행하면 **142/142 + 1 SKIP**(CI 실측. 이 저장소 개발 컨테이너처럼
