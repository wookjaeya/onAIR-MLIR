...
@3 = private constant [53 x i8] c"aarch64/dump/configured_module_infer_dispatch_0.mlir\00", align 1
@4 = private constant [53 x i8] c"aarch64/dump/configured_module_infer_dispatch_1.mlir\00", align 1
@iree_hal_executable_library_query_v0_source_locations = private constant [2 x %iree_hal_executable_source_location_v0_t] [%iree_hal_executable_source_location_v0_t { i32 3, i32 52, ptr @3 }, %iree_hal_executable_source_location_v0_t { i32 3, i32 52, ptr @4 }]
...
!1 = !DIFile(filename: "configured_module_infer_dispatch_0.mlir", directory: "aarch64/dump")
...
!3 = !DIFile(filename: "configured_module_infer_dispatch_1.mlir", directory: "aarch64/dump")
